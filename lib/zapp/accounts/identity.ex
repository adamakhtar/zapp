defmodule Zapp.Accounts.Identity do
  use Ecto.Schema
  ...
  ## Options
    ...
    * `:hash_password` - Hashes the password so it can be stored securely
      ...
      Defaults to `true`.
  """
  def registration_changeset(identity, attrs, opts \\ []) do
    identity
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Zapp.Repo)
  ...
  """
  def valid_password?(%Zapp.Accounts.Identity{hashed_password: hashed_password}, password)
